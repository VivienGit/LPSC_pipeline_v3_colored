...
HD_PWD='C:/Users/Vivien/Documents/Master/S2/LPSC/Section11/mse_mandelbrot_no_bram/mse_mandelbrot.runs/blk_mem_bram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_bram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_bram.tcl
