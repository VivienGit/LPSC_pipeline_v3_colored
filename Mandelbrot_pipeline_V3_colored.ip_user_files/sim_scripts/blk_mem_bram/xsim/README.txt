...
#
# Generated by export_simulation on Tue Apr 17 17:51:17 +0200 2018
#
################################################################################
...
'-reset_run' switch to the './blk_mem_bram.sh' script.

./blk_mem_bram.sh -reset_run
...
./blk_mem_bram.sh -noclean_files

For more information on the script, please type './blk_mem_bram.sh -help'.
